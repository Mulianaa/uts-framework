            ...
            <section class="content">
                ...
                <div class="card card-warning">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-auto">
                                <i class="bi bi-camera-fill " style="font-size: 3.5rem;"></i>
                            </div>
                            <div class="col-11 pr-0">
                                <div class="p-2 bg-light ">
                                    <marquee class="py-3" direction="left" onmouseover="this.stop()" onmouseout="this.start()" scrollamount="10" behavior="scroll">
                                        <b>Selamat datang di website kami STMIK Lombok - Sharing Teknologi - Berbagi Ilmu Tentang Teknologi ## Selamat datang di website kami teknologi.visitklaten.com - Sharing Teknologi - Berbagi Ilmu Tentang Teknologi</b>
                                    </marquee>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modaltam">
                            Tambah
                        </button>

                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalbag">
                            Bagian
                        </button>

                        <!-- Jenis Kebutuhan tombol -->
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modaljen">
                            Jenis Kebutuhan
                        </button>
                                ...
                                <table class="table table-bordered mt-5">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $bgn->bagian }}</td>
                                            <td>
                                                <a href="/bagian/destroy/{{$bgn->id_bagian}}" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                ...
                                <table class="table table-bordered mt-5">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $jns->jenis_keb }}</td>
                                            <td>
                                                <a href="/jenis/destroy/{{$jns->id_jenisKeb}}" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
